...
* The fourth patch adds the output of running `strace` on your assembly program as it uses the new system call
...
0. Write a C program that invokes the new system call
