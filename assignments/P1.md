...
0. Write a C program named `syscall.c` that invokes the new system call
    ...
    * Limit the headers to the following: unistd.h, stdio.h, and stdlib.h
...
0. Test your C program and assembly program
    ...
    * Try running `strace` on your assembly program. Capture the output into a file using `2> strace.log` on the end of the command and add it to the repo as your fourth patch
