...
* Show don't tell
    ...
    * It is much more interesting to see e.g. the actual code, commit message, mailing list discussion, running behavior, etc than a coarse summary or a bullet on a slide
...
* You will propose your choice of topic ahead of time
    ...
    * **Submit your proposal in the `#midpoint` channel on Matrix by midnight September 22th 2026**
...
* You will make your presentation live during class during a pre-assigned slot at the beginning of a particular class session

    * The first presentations will take place during week 0x4 on the 29th of September

    * I will assign slots on a first come first serve basis working backwards from the last slot near the end of the semester

        * The sooner you submit your topic and get it approved, the later the presentation slot you will get and the more time you will have to prepare

        * If you would rather go sooner than later, you can let me know and I can take that into consideration
