...
* Patch 3 adds `username/E1/trace.bp`, your original `bpftrace` program, and a file `username/E1/trace.out` that shows the expected output of a successful trace of the special program making your system call
