...
What is a process, what is a thread?
 - niave answer is fork and pthread create,
 - in reality they are points within a multidimensional space governed by unshare
What is a syscall?
 - niave answer is magic function call that invokes the kernel
...
What is a signal?
 - niave answer is asynchronous notification that calls a function
